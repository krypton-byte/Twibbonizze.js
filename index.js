...
var fs = require("fs");
var Twibbonizze = /** @class */ (function () {
    function Twibbonizze(name) {
        this.name = name;
    }
    Twibbonizze.prototype.create = function (Image) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        stat = (_a.sent()).data;
                        return [2 /*return*/, stat.url || stat.status];
                }
            });
        });
    };
...
;
module.exports = { twisearch: twisearch, Twibbonizze: Twibbonizze };
exports.default = Twibbonizze;
